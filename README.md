...
4. ベータ版、Technical Preview、Limited Previewなどは `status` に `beta` または `preview` を入れる。
...
詳しいGitHub Pages / Actions / Windowsタスクスケジューラ手順は `docs/setup-github-and-windows.md` にまとめています。
